...
\textbf{Central hypothesis.} Plasmid-mediated HGT is a form of sex, and the plasmid paradox is therefore the classical paradox of sex expressed through different molecular machinery: both concern selection on a costly mode of genetic exchange, not the fitness effects of the genetic content exchanged. This identification is operational, not terminological. It brings the extensive theory and evidence on the maintenance of sex and recombination to bear on plasmid persistence. Gerrish's recent framework is particularly well suited to HGT because it quantifies the time-integrated value of breaking linkage between a transferable component and its genetic background. We further hypothesize that this value is generically heavy-tailed and, together with ecological heterogeneity, produces observable signatures that improve inference of $\Rwithin$, $\Rbetween$, and $\RpARG$ when direct observations are sparse.
...
This identification is not an academic exercise. It opens the plasmid paradox to the large theoretical and empirical literature on the maintenance of sex and recombination, converting established results on linkage disequilibrium, fluctuating selection, finite populations, population structure, antagonistic coevolution, and modifier dynamics into candidate mechanisms, null models, and falsification tests for HGT \citep{ottolenormand2002,otto2009}. Gerrish's recent developments are especially well matched to plasmids: fitness is decomposed into a mobile component $X$ and a chromosomal background $Y$, and the object of interest is the cumulative selection generated by breaking the $X$--$Y$ association \citep{gerrish2026sex}. Directional transfer, plasmid loss, and donor limitation alter that calculation, but do not change its population-genetic object.
...
Gomes's earlier bacterial models suggest a second application to plasmid retention. Nonheritable variation in cell longevity allows selection within a cohort to enrich long-lived cells; under antibiotic stress, even small variation converts exponential population decline into a decelerating survival curve and an increasing persister fraction \citep{gomes2019variation}. Applied to heterogeneous plasmid--host associations, the same process predicts selective loss of unstable associations and enrichment of low-loss associations among those observed later. These \emph{persister plasmids} need not carry currently beneficial cargo or represent permanently superior plasmid genotypes. They are the long-retained tail of an association-level distribution that is continually remodelled by selection. The detailed proposal below makes this extension explicit and testable.
...
\textbf{Activity Area 2: Multiscale $R_0$ inference with remodelling selection.} We will build a hierarchical model with two coupled transmission scales: $\Rwithin$, describing acquisition of a focal pARG by new bacterial chromosomal backgrounds within a gut, and $\Rbetween$, describing establishment in close-contact hosts. Linkage-preserving observations will separate horizontal acquisition from clonal expansion. Latent recipient heterogeneity and heterogeneity in plasmid-loss hazard will be remodelled jointly, allowing direct tests of the persister-plasmid hypothesis. Heavy-tail structure from Activity Area 1 will regularize event-specific transmission opportunity, with light-tailed and homogeneous-loss models fitted in parallel. Outputs will be posterior distributions that represent detection limits, missing samples, linkage error, and host-level random effects.
...
\textbf{Why this team.} Gerrish contributes population-genetic theory of adaptation, recombination, and path-ensemble approaches to evolutionary prediction \citep{gerrish1998,devisser1999,gerrish2012,gerrish2026sex}. Gomes contributes theory and inference for heterogeneous systems in which selection remodels cohort composition, alters measured fitness, and can stabilize coexistence \citep{gomes2019variation,gomes2022,gomes2024}. The collaboration addresses the central difficulty in pARG epidemiology: transmission changes genetic associations, while differential acquisition and loss change the ecological composition of hosts and plasmid--host associations. The two theories meet at the scale at which persistence and the Resistance Networks threshold must be inferred.
...
\subsection{Remodelling selection and the persister-plasmid hypothesis}

Gomes et al. showed that individual variation need not be genetically inherited to alter population persistence. In their bacterial growth model, cells differ in longevity or viability, but births continually reset the same baseline distribution. Selection nevertheless changes the composition of the surviving cohort: short-lived cells disappear first, leaving an increasing fraction of long-lived cells. Under antibiotic stress, even slight variation changes exponential decline into a decelerating survival curve and reproduces a persister fraction without requiring mutation or an explicit phenotypic-switching mechanism. The same selection on nonheritable variation can change population-level fitness estimates across stress gradients and, under fluctuating conditions, stabilize coexistence of bacterial types that would otherwise exclude one another \citep{gomes2019variation}.

The 2024 remodelling-selection framework generalizes this logic. Heterogeneous units exposed to a hazard are not depleted at random; those with high hazard leave the at-risk cohort first, so the mean hazard among survivors falls even when no individual mechanism changes. The changing trajectory therefore contains information about the latent distribution, which can be recovered by fitting measurements taken across time or across a selection gradient \citep{gomes2024}. This is precisely the situation created by repeated opportunities for plasmid loss.

Let $\delta\ge0$ be an effective loss hazard for a plasmid--host association, incorporating segregation, copy-number variation, host physiology, expression state, compensatory state, and microenvironment. If $q_0(\delta)$ is the distribution among newly formed associations, then over an episode in which $\delta$ is approximately stable, the distribution among associations still carrying the plasmid after cumulative loss pressure $H_L(t)$ is
\begin{equation}
q_t(\delta)=\frac{q_0(\delta)e^{-\delta H_L(t)}}{\int q_0(u)e^{-uH_L(t)}\dd u}.
\label{eq:persister_plasmids}
\end{equation}
High-loss associations disappear early, whereas the surviving plasmid--host lineages become progressively enriched for low $\delta$. We call the long-retained tail \emph{persister plasmids}: associations that remain vertically linked to a bacterial lineage for many host generations despite little or no current cargo benefit. The low-loss state need not be permanently encoded by the plasmid, but it must remain correlated across enough loss opportunities for selection to act. Host switching or phenotypic resetting can resample $q_0$; the correlation time of $\delta$ is therefore an estimable boundary between persister and effectively homogeneous-loss regimes.

This mechanism predicts prolonged retention over biological observation windows, not unconditional immortality in every closed system. If all loss hazards are positive and there is no renewal, transfer, or environmental fluctuation, eventual extinction remains possible. With vertical renewal, occasional HGT, or changing selection, however, cohort remodelling can maintain a reservoir and can stabilize coexistence. We will distinguish this mechanism from useful cargo and fixed genetic stability by fitting homogeneous-loss, heritable-mixture, and nonheritable-remodelling models to longitudinal plasmid--host linkage data. Prespecified signatures are a nonexponential retention curve, a declining mean loss hazard with association age, reversion toward $q_0$ after host switching, and improved prediction across antibiotic and resource gradients.
...
624) (1.9452,0.27072) (1.9452,0.26519) (1.9452,0.25967) (1.9452,0.25414) (1.9452,0.24862) (1.9452,0.24309) (1.9452,0.23757) (1.9452,0.23204) (1.9452,0.22652) (1.9452,0.22099) (1.9452,0.21547) (1.9452,0.20994) (1.9452,0.20442) (1.9452,0.1989) (1.9452,0.19337) (1.9452,0.18785) (1.9452,0.18232) (1.9452,0.1768) (1.9452,0.17127) (1.9452,0.16575) (1.9452,0.16022) (1.9452,0.1547) (1.9452,0.14917) (1.9452,0.14365) (1.9452,0.13812) (1.9452,0.1326) (1.9452,0.12707) (1.9452,0.12155) (1.9452,0.11602) (1.9829,0.1105) (2.0667,0.10497) (2.0931,0.099448) (2.3496,0.093923) (2.3496,0.088398) (2.4016,0.082873) (2.4016,0.077348) (2.7973,0.071823) (2.8682,0.066298) (2.8682,0.060773) (2.8682,0.055249) (2.8682,0.049724) (2.8682,0.044199) (3.4885,0.038674) (3.4885,0.033149) (3.4885,0.027624) (3.4885,0.022099) (3.4885,0.016575) (3.4885,0.01105) (3.9613,0.0055249)
};
\addlegendentry{empirical CCDF}
...
\label{eq:discount}
\end{equation}
The kernel regularizes extremely long episodes and changes the tail amplitude and cutoff. We will compare a scalar $\delta_p$ with the remodelled distribution in Eq.~\eqref{eq:persister_plasmids}, derive the small-$|U|$ asymptotics, and determine whether the $v^{-1}$ regime persists before a loss-imposed cutoff.
...
\subsection{Remodelling selection in bacterial recipient and retention networks}
...
We will consider gamma, lognormal, finite-mixture, and nonparametric spline representations for $q_0(z)$ and $q_0(\delta)$, with model complexity constrained by predictive performance. The heavy-tail variable $\VHGT$ is not identified with recipient risk $z$ or loss hazard $\delta$. The three represent evolutionary value, ecological opportunity, and association persistence, respectively. Joint inference keeps those mechanisms distinct.
...
The conventional route to predicting pARG spread is to measure more mechanisms and estimate more parameters. Resistance Networks creates an opportunity for a complementary route: measure the events that matter, then ask whether their statistics collapse onto a smaller set of robust laws. If the heavy-tail hypothesis is correct, rare transfer episodes are predictable members of a scaling distribution. If remodelling selection is important, declining acquisition hazard may reflect depletion of permissive recipients, while declining loss hazard may reflect enrichment of persister plasmids rather than improved mean plasmid utility. Both effects change how early observations should be extrapolated.
...
\textbf{M. Gabriela M. Gomes, Co-Principal Investigator.} Gomes is a mathematical epidemiologist with long-standing contributions to models of individual variation in susceptibility, exposure, longevity, infection, vaccination, and epidemic thresholds \citep{gomes2004,gomes2019variation,gomes2022,gomes2024}. Her work shows how selection on nonheritable variation remodels surviving cohorts, biases measured fitness, and can stabilize coexistence. She will lead Activity Area 2, including tests of the persister-plasmid hypothesis, latent-heterogeneity inference, next-generation operator construction, threshold interpretation, and validation design.
